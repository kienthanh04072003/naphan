...
public class PhanSo {
    ...
    public void congPhanSo(PhanSo ps) {
        ...
        System.out.println("Tong hai phân so = " + phanSoTong.tu + "/" + phanSoTong.mau);
    }
    ...
    public void truPhanSo(PhanSo ps) {
        ...
        System.out.println("Hieu hai phân so = " + phanSoHieu.tu + "/" + phanSoHieu.mau);
    }
    ...
    public void nhanPhanSo(PhanSo ps) {
        ...
        System.out.println("Tich hai phân so = " + phanSoTich.tu + "/" + phanSoTich.mau);
    }
    ...
    public void chiaPhanSo(PhanSo ps) {
        ...
        System.out.println("Thuong hai phân so = " + phanSoThuong.tu + "/" + phanSoThuong.mau);
    }
}
